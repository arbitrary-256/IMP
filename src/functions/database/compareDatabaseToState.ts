...
export const compareDatabaseToState = async (current: IIMPProduct[], last: IIMPProduct[]): Promise<void> => {
  ...
  //     const thisQuery = `INSERT INTO products (id, name, price, quantity, description, image) VALUES ('${product.upc}', '${product.name}', '${product.price}', '${product.cost}', '${product.onHand}', '${product.min}', '${product.max}', '${product.image}')`
